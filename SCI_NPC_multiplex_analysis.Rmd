...
two_group_test <- function(list_object){
  ...
  return(norm_assump_2)
}

do.call(rbind, lapply(split(DT_melt, DT_melt[, .(variable, evaluation_weeks)]), function(subset){two_group_test(subset)}))

#verify correct calculations
#add selection of statistical test and output p_value
#add to plot  
